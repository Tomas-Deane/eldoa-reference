...
export const exercises = [
  ...
  exercise("l1-l2", "L1", "L2", "lumbar", 63.43, "rect12", {
    image: "/poses/l1-l2.png",
    setup: [
      "Sit with the chest tall in the gravity line. Chin down, cheekbones over collarbones; lengthen the back of the neck.",
      "Breathe the rib cage up off the pelvis. Extend both legs about hip-width apart with the knees straight.",
      "Pull the toes back and reach the heels away from the pelvis.",
      "Turn the knees toward each other. Pull the big toes toward the face and push the pinky toes away.",
      "Reach both arms forward in external rotation, then raise them toward the ceiling.",
    ],
    hold: [
      "Open the arms about 45 degrees and reach the hands away from the heart.",
      "Keep the heels reaching out, big toes toward the face and pinky toes pushing away.",
      "Stay in the gravity line. Breathe the rib cage up off the pelvis.",
      "Reach the hands and heels away; spread the fingers as hard as possible.",
      "Look down toward the knees while the head reaches toward the ceiling. Keep breathing smoothly.",
    ],
  }),
  exercise("l2-l3", "L2", "L3", "lumbar", 67.46, "rect10", {
    image: "/poses/l2-l3.png",
    setup: [
      "Sit with a tall gravity-line spine, pushing through the crown of the head.",
      "Open the straight legs comfortably wide—between legs-together and the splits.",
      "Dorsiflex the ankles and drive the heels away. Lift through the spine in axial extension.",
      "Deepen the femoral sockets and internally rotate the legs to your maximum.",
      "Add pseudo-inversion: pull the big toes toward the knees, push the pinky toes away and splay the toes.",
    ],
    hold: [
      "Think about decoapting—pushing the femurs out of the hips—while keeping a tall spine.",
      "Externally rotate the arms: elbow creases up, palms open and fingers spread.",
      "Reach both arms straight toward the sky and push the palms up.",
      "Drive the heels away while maintaining femoral internal rotation and pseudo-inversion.",
